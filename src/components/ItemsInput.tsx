      ...
      <div>
        <div className="input-order-area">
          ...
          <input
            ...
            onFocus={() => {
              setItemInputFocus(true);
            }}
            onBlur={() => {
              setTimeout(() => {
                setItemInputFocus(false);
              }, 100);
            }}
          />
          <div
        ...
        <div className="input-order-area">
          ...
          <input
            ...
            onChange={unitChange}
            onFocus={() => {
              setUnitInputFocus(true);
            }}
            onBlur={() => {
              setTimeout(() => {
                setUnitInputFocus(false);
              }, 100);
            }}
          />
          <div
        ...
        <div className="input-order-area">
          ...
          <div className="item-input-unit">
            <button
              onClick={() => {
                setQuantity(
                  Number(quantity) <= 0 ? '0' : `${Number(quantity) - 1}`
                );
              }}>
        ...
        <button className="orderBtn" onClick={onSubmit}>
          주문 추가하기
        </button>
      </div>
    </div>
